...
function Shoot () {
	...
	// Fire frisbee
	var f : Transform = Instantiate(frisbee,transform.position + transform.forward * 1.1,transform.rotation); //here you can rotate 2x the angle downhill or just look at the player
